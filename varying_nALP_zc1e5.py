...
# Omega_axion_ac = [1.3e+14,2e+14,2.5e+14]
...
fig_TT, (ax_TT, ax_EE, ax_PP) = plt.subplots(3,1, sharex=True,gridspec_kw=dict(height_ratios=[1,1,1]),figsize=(15,15))
# fig_Pk, ax_Pk = plt.subplots()
...
ax_PP.tick_params(axis='x',labelsize=30)
ax_PP.tick_params(axis='y',labelsize=30)

ax_TT.axis([2,2500,-0.5,0.5])
ax_PP.axis([2,2500,-0.5,0.5])
...
for i in range(var_num):
    ...
    ax_PP.semilogx(ll,(clPP-clPP_LCDM)/clPP_LCDM,var_color,linestyle='-')
    #
    # reset CLASS
    #
    M.struct_cleanup()
...
# ax_Pk.text(0.01,0.,r'$\frac{\Delta P(k)}{P(k)^{\Lambda{\rm CDM}}}$',fontsize=40)
ax_PP.set_xlabel(r'$\ell$',fontsize=40)
ax_PP.text(50,0.15,r'$\frac{\Delta C_\ell^{\phi\phi}}{C_\ell^{\phi\phi}({\Lambda{\rm CDM}})}$',fontsize=40)
# ax_PP.text(50,0.015,r'$\frac{\Delta C_\ell^{\phi\phi}}{C_\ell^{\phi\phi}({\Lambda{\rm CDM}})}$',fontsize=40)
...
# ax_TT.text(50,0.015,r'$\frac{\Delta C_\ell^\mathrm{TT}}{C_\ell^\mathrm{TT}(\Lambda{\rm CDM})}$',fontsize=40)
...
ax_TT.legend(legarray,frameon=False,prop={'size':30},loc='lower right',borderaxespad=0.)
...
# ax_EE.text(50,0.015,r'$\frac{\Delta C_\ell^\mathrm{EE}}{C_\ell^\mathrm{EE}(\Lambda{\rm CDM})}$',fontsize=40)
# ax_EE.set_ylabel(r'$\frac{\Delta C_\ell^\mathrm{EE}}{C_\ell^\mathrm{EE}(\Lambda{\rm CDM})}$',fontsize=40)
# fig_TT.tight_layout()
# fig_TT.show()
fig_TT.savefig('spectra_%s_cltt_1em5.pdf' % var_figname)
